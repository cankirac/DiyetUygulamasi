...
class DeviceUtils {
    ...
    static let DEVICE_MODEL = UIDevice().DEVICE_MODEL
    static let DEVICE_MODEL_NAME = UIDevice().DEVICE_MODEL.rawValue
    static let DEVICE_SYSTEM_VERSION = UIDevice().systemVersion
    
    static func getDeviceConfigDetails (){
        print("***** DEVICE CONFIGURATION & DETAILS *****")
        print("DEVICE WIDTH: ", DEVICE_WIDTH)
        print("DEVICE HEIGHT: ", DEVICE_HEIGHT)
        print("DEVICE SIZE: ", DEVICE_SIZE)
        print("DEVICE MODEL: ", DEVICE_MODEL)
        print("DEVICE MODEL NAME: ", DEVICE_MODEL_NAME)
        print("DEVICE SYSTEM VERSION: ", DEVICE_SYSTEM_VERSION)
        print("***** ***** ***** ***** *****")
    }
}
...
enum Model : String {
    ...
    UNRECOGNIZED       = "UNRECOGNIZED APPLE DEVICE"
}
