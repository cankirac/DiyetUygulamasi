...
var kanBasıncı = ["High Blood Pressure", "1200 Calories BP", "1500 Calories BP", "2000 Calories", "7 Day Blood Pressure"]
var gluttensiz = ["7 Gün Gluttensiz", "Gluttensiz"]
var sütsüz = ["Süt Ürünleri İçermez", "Sağlıklı Gebelik", "1200 Kalori", "1500 Kalori"]
var şekersiz = ["Diyabet", "Şeker-Detoks", "Şekersiz"]
var temizBeslenme = ["Başlangıç", "İleri Düzey", "Orta"]
var vejetaryen = ["7 Günde Kilo Verme", "7 Günde Sağlıklı"]
var diğerleri = ["7 Gün Akdeniz", "Eleme"]
